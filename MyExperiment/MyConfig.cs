...
namespace MyExperiment
{
    ...
    public class MyConfig
    {
        ...
        /// <summary>
        /// The name of the Azure Storage Blob Container, where training files are located.
        /// </summary>
        public string TrainingContainer { get; set; }

        /// <summary>
        /// The name of the Azure Storage Blob Container, where result files will be uploaded.
        /// </summary>
        public string ResultContainer { get; set; }

        /// <summary>
        /// The name of the Azure Storage Table where result information will be uploaded.
        /// </summary>
